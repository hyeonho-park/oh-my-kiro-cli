...
- Read all sources and cluster by topic
- Assign each cluster: canonical_id, domain, list of source files
...
## Entry Point
User invokes with: {content} @kb-create

## Agents
- kb-curator: sole writer for wiki, _index.md, manifest.json
